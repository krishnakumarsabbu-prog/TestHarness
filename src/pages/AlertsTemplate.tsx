      ...
      <div className="space-y-6">
        ...
        {!loading && !fetched && (
          <div className="flex flex-col items-center justify-center gap-3 py-16 text-center">
            ...
            <div>
              <p className="text-sm font-medium text-slate-700">No template loaded</p>
              <p className="text-xs text-slate-400 mt-0.5">Configure the parameters above and click Fetch Templates</p>
            </div>
          </div>
        )}
        ...
        {!loading && result && (
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            <SectionCard
              ...
              noPadding
            >
              <pre className="overflow-auto text-xs leading-relaxed font-mono whitespace-pre-wrap break-words text-green-300 bg-slate-950 rounded-b-2xl p-5 max-h-[480px]">
                {result.rawTemplate}
              </pre>
            </SectionCard>
